 ...
 * @param {string} secretKey - Encryption key (32 characters)
 * @returns {Promise<string>} - Returns format: base64(iv):base64(encrypted data)
 */
...
/**
 * Decrypt text
 * @param {string} encryptedData - Encrypted data (format: base64(iv):base64(encrypted data))
 * @param {string} secretKey - Encryption key (32 characters)
