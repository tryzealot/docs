        ...
        <div className={styles.heroContent}>
          <div className={styles.heroText}>
            ...
            <p className={styles.heroSubtitle}>
              ...
              >
                Deploy and distribute your Android, iOS, macOS, Windows and
                Linux apps with ease. Open source, self-hosted solution for
                managing beta releases and app lifecycle.
              </Translate>
            </p>
